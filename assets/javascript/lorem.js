...
!function(e, t) {
    ...
    var h = function(n) {
        var e, p, b, o, r, h, f, g, w, l, c, E, C, s, T, m, a, u, v, x = "sizzle" + 1 * new Date, y = n.document, A = 0, i = 0, d = se(), _ = se(), D = se(), S = function(e, t) {
            return e === t && (c = !0),
            0
            ...
            for (var n = 0, i = e.length; n < i; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, P = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", H = "[\\x20\\t\\r\\n\\f]", M = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", $ = "\\[" + H + "*(" + M + ")(?:" + H + "*([*^$|!~]?=)" + H + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + M + "))|)" + H + "*\\]", R = ":(" + M + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + $ + ")*)|.*)\\)|)", U = new RegExp(H + "+","g"), W = new RegExp("^" + H + "+|((?:^|[^\\\\])(?:\\\\.)*)" + H + "+$","g"), F = new RegExp("^" + H + "*," + H + "*"), q = new RegExp("^" + H + "*([>+~]|" + H + ")" + H + "*"), B = new RegExp("=" + H + "*([^\\]'\"]*?)" + H + "*\\]","g"), K = new RegExp(R), V = new RegExp("^" + M + "$"), Q = {
            ID: new RegExp("^#(" + M + ")"),
            CLASS: new RegExp("^\\.(" + M + ")"),
            TAG: new RegExp("^(" + M + "|[*])"),
            ATTR: new RegExp("^" + $),
        ...
        oe.matchesSelector = function(e, t) {
            ...
            t = t.replace(B, "='$1']"),
            p.matchesSelector && T && !D[t + " "] && (!a || !a.test(t)) && (!m || !m.test(t)))
                try {
                    var n = u.call(e, t);
                ...
                CHILD: function(h, e, t, g, m) {
                    ...
                    : function(e, t, n) {
                        ...
                        if (u) {
                            ...
                            y && d) {
                                for (p = (a = (i = (r = (o = (s = u)[x] || (s[x] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[h] || [])[0] === A && i[1]) && i[2],
                                s = a && u.childNodes[a]; s = ++a && s && s[c] || (p = a = 0) || l.pop(); )
                                    if (1 === s.nodeType && ++p && s === e) {
                                        r[h] = [A, a, p];
                                        break
                                    }
                            } else if (d && (p = a = (i = (r = (o = (s = e)[x] || (s[x] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[h] || [])[0] === A && i[1]),
                            !1 === p)
                                for (; (s = ++a && s && s[c] || (p = a = 0) || l.pop()) && ((_ ? s.nodeName.toLowerCase() !== f : 1 !== s.nodeType) || !++p || (d && ((r = (o = s[x] || (s[x] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[h] = [A, p]),
                                s !== e)); )
                                    ;
            ...
            ae(function(e, t, n, i) {
                var r, o, s, a = [], l = [], c = t.length, u = e || function(e, t, n) {
                    for (var i = 0, r = t.length; i < r; i++)
                        oe(e, t[i], n);
                    return n
                }(h || "*", n.nodeType ? [n] : n, []), f = !p || !e && h ? u : be(u, a, p, n, i), d = g ? v || (e ? p : c || m) ? [] : t : f;
                if (g && g(f, d, n, i),
                m)
                    for (r = be(d, l),
                    m(r, [], n, i),
        ...
        h = oe.tokenize = function(e, t) {
            ...
            a = [],
            l = b.preFilter; s; ) {
                for (o in n && !(i = F.exec(s)) || (i && (s = s.slice(i[0].length) || s),
                a.push(r = [])),
                n = !1,
        ...
        f = oe.compile = function(e, t) {
            ...
            if (!s) {
                ...
                i = function(e, t, n, i, r) {
                    var o, s, a, l = 0, c = "0", u = e && [], f = [], d = w, p = e || _ && b.find.TAG("*", r), h = A += null == d ? 1 : Math.random() || .1, g = p.length;
                    for (r && (w = t === C || t || r); c !== g && null != (o = p[c]); c++) {
                        if (_ && o) {
                            for (s = 0,
        ...
        g = oe.select = function(e, t, n, i) {
            ...
            1 === u.length) {
                ...
                !b.relative[a = s.type]); )
                    if ((l = b.find[a]) && (i = l(s.matches[0].replace(J, ee), Z.test(o[0].type) && ge(t.parentNode) || t))) {
                        if (o.splice(r, 1),
                        !(e = i.length && ve(o)))
                            return O.apply(n, i),
                            n;
            ...
            return (c || f(e, u))(i, t, !T, n, !t || Z.test(e) && ge(t.parentNode) || t),
            n
        }
        ,
        p.sortStable = x.split("").sort(S).join("") === x,
    ...
    x.fn.extend({
        ...
        is: function(e) {
            return !!I(this, "string" == typeof e && D.test(e) ? x(e) : e || [], !1).length
        }
    });
    var N, O = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    ...
    x.Deferred.exceptionHook = function(e, t) {
        C.console && C.console.warn && e && U.test(e.name) && C.console.warn("jQuery.Deferred exception: " + e.message, e.stack, t)
    }
    ,
    ...
    x.extend({
        ...
        readyWait: 1,
        ready: function(e) {
            (!0 === e ? --x.readyWait : x.isReady) || (x.isReady = !0) !== e && 0 < --x.readyWait || W.resolveWith(T, [x])
        }
    }),
    x.ready.then = W.then,
    "complete" === T.readyState || "loading" !== T.readyState && !T.documentElement.doScroll ? C.setTimeout(x.ready) : (T.addEventListener("DOMContentLoaded", F),
    C.addEventListener("load", F));
    var q = function e(t, n, i, r, o, s, a) {
        var l = 0
          , c = t.length
          , u = null == i;
        if ("object" === w(i))
    ...
    ge = T.createDocumentFragment().appendChild(T.createElement("div")),
    ...
    x.event = {
        ...
        add: function(t, e, n, i, r) {
            var o, s, a, l, c, u, f, d, p, h, g, m = G.get(t);
            if (m)
        ...
        remove: function(e, t, n, i, r) {
            var o, s, a, l, c, u, f, d, p, h, g, m = G.hasData(e) && G.get(e);
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(H) || [""]).length; c--; )
                    if (p = g = (a = Ee.exec(t[c]) || [])[1],
                    h = (a[2] || "").split(".").sort(),
                    p) {
                        ...
                        s && !d.length && (f.teardown && !1 !== f.teardown.call(e, h, m.handle) || x.removeEvent(e, p, m.handle),
                        delete l[p])
                    } else
                        for (p in l)
    ...
    function Ue(e, t, n) {
        ...
        !v.pixelBoxStyles() && Me.test(s) && Re.test(t) && (i = a.width,
        r = a.minWidth,
        o = a.maxWidth,
    ...
    x.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, s, a = Q(t), l = qe.test(t), c = e.style;
                if (l || (t = ze(a)),
    ...
    x.each(["height", "width"], function(e, a) {
        x.cssHooks[a] = {
            get: function(e, t, n) {
                if (t)
                    return !Fe.test(x.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Xe(e, a, n) : oe(e, Be, function() {
                        return Xe(e, a, n)
                    })
            },
            set: function(e, t, n) {
    ...
    x.cssHooks.marginLeft = We(v.reliableMarginLeft, function(e, t) {
        if (t)
            return (parseFloat(Ue(e, "marginLeft")) || e.getBoundingClientRect().left - oe(e, {
                marginLeft: 0
            }, function() {
                return e.getBoundingClientRect().left
            })) + "px"
    ...
    x.Animation = x.extend(ct, {
        ...
        prefilters: [function(e, t, n) {
            var i, r, o, s, a, l, c, u, f = "width"in t || "height"in t, d = this, p = {}, h = e.style, g = e.nodeType && re(e), m = G.get(e, "fxshow");
    ...
    x.fn.extend({
        ...
        toggleClass: function(r, t) {
            ...
            return "boolean" == typeof t && s ? t ? this.addClass(r) : this.removeClass(r) : y(r) ? this.each(function(e) {
                x(this).toggleClass(r.call(this, e, gt(this), t), t)
            }) : this.each(function() {
                var e, t, n, i;
                if (s)
                    for (t = 0,
                    ...
                    void 0 !== r && "boolean" !== o || ((e = gt(this)) && G.set(this, "__className__", e),
    ...
    x.extend(x.event, {
        trigger: function(e, t, n, i) {
            var r, o, s, a, l, c, u, f, d = [n || T], p = m.call(e, "type") ? e.type : e, h = m.call(e, "namespace") ? e.namespace.split(".") : [];
            if (o = f = s = n = n || T,
    ...
    function Dt(n, e, i, r) {
        ...
        if (Array.isArray(e))
            x.each(e, function(e, t) {
                i || Ct.test(n) ? r(n, t) : Dt(n + "[" + ("object" === (void 0 === t ? "undefined" : _typeof(t)) && null != t ? e : "") + "]", t, i, r)
            });
    ...
    x.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !x(this).is(":disabled") && At.test(this.nodeName) && !xt.test(e) && (this.checked || !ce.test(e))
            }).map(function(e, t) {
                var n = x(this).val();
    ...
    x.extend({
        ...
        ajax: function(e, t) {
            ...
            e = void 0),
            t = t || {};
            var u, f, d, n, p, i, h, g, r, o, m = x.ajaxSetup({}, t), v = m.context || m, y = m.context && (v.nodeType || v.jquery) ? x(v) : x.event, _ = x.Deferred(), b = x.Callbacks("once memory"), w = m.statusCode || {}, s = {}, a = {}, l = "canceled", E = {
                readyState: 0,
            ...
            if (_.promise(E),
            m.url = ((e || m.url || bt.href) + "").replace(Lt, bt.protocol + "//"),
            ...
            null == m.crossDomain) {
                ...
                try {
                    i.href = m.url,
                    i.href = i.href,
                    m.crossDomain = Mt.protocol + "//" + Mt.host != i.protocol + "//" + i.host
                } catch (e) {
                    m.crossDomain = !0
                }
            }
            if (m.data && m.processData && "string" != typeof m.data && (m.data = x.param(m.data, m.traditional)),
            Rt(jt, m, t, E),
            h)
                return E;
            for (r in (g = x.event && m.global) && 0 == x.active++ && x.event.trigger("ajaxStart"),
            m.type = m.type.toUpperCase(),
            m.hasContent = !Ot.test(m.type),
            f = m.url.replace(kt, ""),
            m.hasContent ? m.data && m.processData && 0 === (m.contentType || "").indexOf("application/x-www-form-urlencoded") && (m.data = m.data.replace(St, "+")) : (o = m.url.slice(f.length),
            m.data && (m.processData || "string" == typeof m.data) && (f += (Et.test(f) ? "&" : "?") + m.data,
            delete m.data),
            !1 === m.cache && (f = f.replace(It, "$1"),
            o = (Et.test(f) ? "&" : "?") + "_=" + wt++ + o),
            m.url = f + o),
            m.ifModified && (x.lastModified[f] && E.setRequestHeader("If-Modified-Since", x.lastModified[f]),
            ...
            E.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + Ht + "; q=0.01" : "") : m.accepts["*"]),
            m.headers)
                E.setRequestHeader(r, m.headers[r]);
            if (m.beforeSend && (!1 === m.beforeSend.call(v, E, m) || h))
                return E.abort();
            if (l = "abort",
            b.add(m.complete),
            E.done(m.success),
            ...
            function c(e, t, n, i) {
                ...
                r ? (m.ifModified && ((l = E.getResponseHeader("Last-Modified")) && (x.lastModified[f] = l),
    ...
    v.createHTMLDocument = ((qt = T.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
...
function(e, t) {
    ...
    function y(e) {
        if (!e)
            return document.documentElement;
        for (var t = g(10) ? document.body : null, n = e.offsetParent; n === t && e.nextElementSibling; )
            n = (e = e.nextElementSibling).offsetParent;
        var i = n && n.nodeName;
            ...
            flip: {
                ...
                fn: function(h, g) {
                    ...
                    if (h.flipped && h.placement === h.originalPlacement)
                        return h;
                    var m = D(h.instance.popper, h.instance.reference, g.padding, g.boundariesElement, h.positionFixed)
                    ...
                    return b.forEach(function(e, t) {
                        ...
                        v = h.placement.split("-")[0],
                        y = N(v);
                        var n, i = h.offsets.popper, r = h.offsets.reference, o = Math.floor, s = "left" === v && o(i.right) > o(r.left) || "right" === v && o(i.left) < o(r.right) || "top" === v && o(i.bottom) > o(r.top) || "bottom" === v && o(i.top) < o(r.bottom), a = o(i.left) < o(m.left), l = o(i.right) > o(m.right), c = o(i.top) < o(m.top), u = o(i.bottom) > o(m.bottom), f = "left" === v && a || "right" === v && l || "top" === v && c || "bottom" === v && u, d = -1 !== ["top", "bottom"].indexOf(v), p = !!g.flipVariations && (d && "start" === _ && a || d && "end" === _ && l || !d && "start" === _ && c || !d && "end" === _ && u);
                        (s || f || p) && (h.flipped = !0,
                        (s || f) && (v = b[t + 1]),
...
var Util = function(i) {
      ...
      , g = function() {
        ...
        return n.prototype.toggle = function() {
            ...
            if (n) {
                ...
                if (i) {
                    if ("radio" === i.type)
                        if (i.checked && o(this._element).hasClass(s))
                            e = !1;
                        else {
                            var r = o(n).find(d)[0];
                            r && o(r).removeClass(s)
                    ...
                    if (e) {
                        if (i.hasAttribute("disabled") || n.hasAttribute("disabled") || i.classList.contains("disabled") || n.classList.contains("disabled"))
                            return;
                        i.checked = !o(this._element).hasClass(s),
                        o(i).trigger("change")
                    }
                    i.focus(),
                    t = !1
            ...
            t && this._element.setAttribute("aria-pressed", !o(this._element).hasClass(s)),
    ...
    var t = "carousel"
      ...
      , o = function() {
        function o(e, t) {
            ...
            this._element = p(e)[0],
            this._indicatorsElement = p(this._element).find(T.INDICATORS)[0],
        ...
        o.prototype.pause = function(e) {
            e || (this._isPaused = !0),
            p(this._element).find(T.NEXT_PREV)[0] && (Util.triggerTransitionEnd(this._element),
            this.cycle(!0)),
        ...
        o.prototype.to = function(e) {
            var t = this;
            this._activeElement = p(this._element).find(T.ACTIVE_ITEM)[0];
        ...
        o.prototype._getItemIndex = function(e) {
            return this._items = p.makeArray(p(e).parent().find(T.ITEM)),
        ...
        o.prototype._triggerSlideEvent = function(e, t) {
            var n = this._getItemIndex(e)
              , i = this._getItemIndex(p(this._element).find(T.ACTIVE_ITEM)[0])
              , r = p.Event(v.SLIDE, {
                relatedTarget: e,
                direction: t,
                from: i,
        ...
        o.prototype._setActiveIndicatorElement = function(e) {
            if (this._indicatorsElement) {
                p(this._indicatorsElement).find(T.ACTIVE).removeClass(y);
        ...
        o.prototype._slide = function(e, t) {
            var n = this
              , i = p(this._element).find(T.ACTIVE_ITEM)[0]
  ...
  , Collapse = function(l) {
    var t = "collapse"
      ...
      , a = function() {
        function a(e, t) {
            ...
            for (var n = l(g.DATA_TOGGLE), i = 0; i < n.length; i++) {
                var r = n[i]
                  , o = Util.getSelectorFromElement(r);
        ...
        a.prototype.show = function() {
            ...
            if (!this._isTransitioning && !l(this._element).hasClass(f)) {
                var t = void 0
                  , n = void 0;
                if (this._parent && 0 === (t = l.makeArray(l(this._parent).find(g.ACTIVES).filter('[data-parent="' + this._config.parent + '"]'))).length && (t = null),
                !(t && (n = l(t).not(this._selector).data(c)) && n._isTransitioning)) {
                    ...
                    !i.isDefaultPrevented()) {
                        ...
                        l(this._element).removeClass(d).addClass(p),
                        (this._element.style[r] = 0) < this._triggerArray.length && l(this._triggerArray).removeClass(h).attr("aria-expanded", !0),
                        this.setTransitioning(!0);
                        var o = "scroll" + (r[0].toUpperCase() + r.slice(1))
                          , s = Util.getTransitionDurationFromElement(this._element);
                        l(this._element).one(Util.TRANSITION_END, function() {
                            l(e._element).removeClass(p).addClass(d).addClass(f),
                            e._element.style[r] = "",
        ...
        a.prototype.hide = function() {
            ...
            if (!this._isTransitioning && l(this._element).hasClass(f)) {
                ...
                !t.isDefaultPrevented()) {
                    ...
                    l(this._element).addClass(p).removeClass(d).removeClass(f),
                    0 < this._triggerArray.length)
                        for (var i = 0; i < this._triggerArray.length; i++) {
                            var r = this._triggerArray[i]
                              , o = Util.getSelectorFromElement(r);
                            if (null !== o)
                                l(o).hasClass(f) || l(r).addClass(h).attr("aria-expanded", !1)
                        }
                    this.setTransitioning(!0);
                    ...
                    l(this._element).one(Util.TRANSITION_END, function() {
                        e.setTransitioning(!1),
                        l(e._element).removeClass(p).addClass(d).trigger(u.HIDDEN)
                    }).emulateTransitionEnd(s)
                }
            }
        }
    ...
    return l(document).on(u.CLICK_DATA_API, g.DATA_TOGGLE, function(e) {
  ...
  , Dropdown = function(c) {
    var t = "dropdown"
      ...
      , S = function() {
                ...
                !t) {
                    ...
                    !i.isDefaultPrevented()) {
                        if (!this._inNavbar) {
                            ...
                            "scrollParent" !== this._config.boundary && c(e).addClass(g),
                            this._popper = new Popper(r,this._menu,this._getPopperConfig())
                        }
                        "ontouchstart"in document.documentElement && 0 === c(e).closest(y).length && c(document.body).children().on("mouseover", null, c.noop),
                        this._element.focus(),
                        this._element.setAttribute("aria-expanded", !0),
                        c(this._menu).toggleClass(d),
                        c(e).toggleClass(d).trigger(c.Event(f.SHOWN, n))
                    }
                }
            }
        }
        ...
        l.prototype._getPlacement = function() {
            ...
            c(this._menu).hasClass(h) && (t = w)) : e.hasClass(o) ? t = T : e.hasClass(p) ? t = x : c(this._menu).hasClass(h) && (t = C),
            t
        }
        ,
        ...
        l._clearMenus = function(e) {
            if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which))
                for (var t = c.makeArray(c(m)), n = 0; n < t.length; n++) {
                    ...
                    if (r) {
                        ...
                        if (c(i).hasClass(d) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && c.contains(i, e.target))) {
                            ...
                            c(s).removeClass(d),
                            c(i).removeClass(d).trigger(c.Event(f.HIDDEN, o)))
                        }
                    }
                }
        }
        ...
        l._dataApiKeydownHandler = function(e) {
            if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || c(e.target).closest(v).length)) : s.test(e.which)) && (e.preventDefault(),
            e.stopPropagation(),
            !this.disabled && !c(this).hasClass(a))) {
                var t = l._getParentFromElement(this)
                  , n = c(t).hasClass(d);
                if ((n || 27 === e.which && 32 === e.which) && (!n || 27 !== e.which && 32 !== e.which)) {
                    var i = c(t).find(_).get();
                    if (0 !== i.length) {
    ...
    return c(document).on(f.KEYDOWN_DATA_API, m, S._dataApiKeydownHandler).on(f.KEYDOWN_DATA_API, v, S._dataApiKeydownHandler).on(f.CLICK_DATA_API + " " + f.KEYUP_DATA_API, S._clearMenus).on(f.CLICK_DATA_API, m, function(e) {
        e.preventDefault(),
        e.stopPropagation(),
        S._jQueryInterface.call(c(this), "toggle")
    }).on(f.CLICK_DATA_API, l, function(e) {
        e.stopPropagation()
    }),
    c.fn[t] = S._jQueryInterface,
    c.fn[t].Constructor = S,
  ...
  , modalB = function(s) {
    var t = "modalB"
      ...
      , h = {
        ...
        DATA_TOGGLE: '[data-toggle="modalB"]',
        DATA_DISMISS: '[data-dismiss="modalB"]',
      ...
      , g = function() {
        function r(e, t) {
            ...
            this._config = this._getConfig(t),
            this._element = e,
            this._dialog = s(e).find(h.DIALOG)[0],
            this._backdrop = null,
            this._isShown = !1,
        ...
        ,
        r.prototype._hidemodalB = function() {
            var e = this;
        ...
        r.prototype._setScrollbar = function() {
            ...
            if (this._isBodyOverflowing) {
                s(h.FIXED_CONTENT).each(function(e, t) {
                ...
                s(h.STICKY_CONTENT).each(function(e, t) {
                ...
                s(h.NAVBAR_TOGGLER).each(function(e, t) {
                    var n = s(t)[0].style.marginRight
                      , i = s(t).css("margin-right");
                    s(t).data("margin-right", n).css("margin-right", parseFloat(i) + r._scrollbarWidth + "px")
                });
        ...
        r.prototype._resetScrollbar = function() {
            ...
            s(h.STICKY_CONTENT + ", " + h.NAVBAR_TOGGLER).each(function(e, t) {
    ...
    return s(document).on(l.CLICK_DATA_API, h.DATA_TOGGLE, function(e) {
        ...
        g._jQueryInterface.call(s(n), r, this)
    }),
    s.fn[t] = g._jQueryInterface,
    s.fn[t].Constructor = g,
    ...
    var t = "tooltip"
      ...
      , i = function() {
        ...
        i.prototype.toggle = function(e) {
            if (this._isEnabled)
                if (e) {
                    ...
                    if (u(this.getTipElement()).hasClass(g))
        ...
        i.prototype.dispose = function() {
            ...
            u(this.element).closest(".modalB").off("hide.bs.modalB"),
        ...
        i.prototype._setListeners = function() {
            ...
            this.config.trigger.split(" ").forEach(function(e) {
                ...
                u(i.element).closest(".modalB").on("hide.bs.modalB", function() {
                    return i.hide()
                })
            }),
        ...
        i.prototype._enter = function(e, t) {
            ...
            u(t.getTipElement()).hasClass(g) || t._hoverState === f ? t._hoverState = f : (clearTimeout(t._timeout),
            t._hoverState = f,
    ...
    var n = "scrollspy"
      ...
      , i = function() {
        ...
        return i.prototype.refresh = function() {
            ...
            s.makeArray(s(this._selector)).map(function(e) {
                var t = void 0
                  , n = Util.getSelectorFromElement(e);
                if (n && (t = s(n)[0]),
                t) {
        ...
        i.prototype._clear = function() {
            s(this._selector).filter(f.ACTIVE).removeClass(u)
        }
        ,
        i._jQueryInterface = function(n) {
            return this.each(function() {
      ...
      , i = function() {
        ...
        return i.prototype.show = function() {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && c(this._element).hasClass(f) || c(this._element).hasClass(d))) {
                var e = void 0
                  , i = void 0
                  , t = c(this._element).closest(p)[0]
                  , r = Util.getSelectorFromElement(this._element);
                if (t) {
                    var o = "UL" === t.nodeName ? g : h;
        ...
        i.prototype._activate = function(e, t, n) {
            var i = this
              , r = ("UL" === t.nodeName ? c(t).find(g) : c(t).children(h))[0]
        ...
        i.prototype._transitionComplete = function(e, t, n) {
            ...
            Util.reflow(e),
            c(e).addClass(s),
            e.parentNode && c(e.parentNode).hasClass(o)) {
                var r = c(e).closest(a)[0];
                r && c(r).find(m).addClass(f),
...
$(window).on("scroll", function() {
    50 <= $(this).scrollTop() ? $('a[data-attribute*="return-to-top"]').fadeIn(200) : $('a[data-attribute*="return-to-top"]').fadeOut(200)
}),
...
$(function() {
    $("body").on("click", ".form-group input + label, .form-group textarea + label", function() {
        ...
        for (i = 0; i < t; i++)
            ...
            n = n + e.currentTarget.files[i].name + " (" + filesize + "kb); ";
        1 < t && (r = t + " file da caricare: "),
        $(this).siblings(".form-file-name").text(r + n)
    }),
